...
import { getCompanySettings, updateCompanySettings, getHomepageConfig, updateHeroConfig, updateFooterConfig, updateHighlightsConfig, updateAboutConfig, uploadAdminImage, toggleAnnouncementBar } from "../controllers/companySettings.controller";
...
// Homepage config (hero + footer + highlights + about templates)
...
router.put("/homepage-config/highlights", authMiddleware, adminMiddleware, updateHighlightsConfig);
router.put("/homepage-config/about", authMiddleware, adminMiddleware, updateAboutConfig);
